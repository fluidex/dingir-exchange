...
async function initUser(): Promise<number> {
  ...
  const acc = Account.fromMnemonic(mnemonic1);
...
async function main() {
  ...
  while (true) {
    ...
    if (count % 100 == 0) {
      ...
      console.log("depth:", await defaultClient.orderDepth(market, 20, "0.1"));
      ...
      async function printBalance() {
        ...
        console.log(
          "------- BALANCE2:",
          allQuote,
          allBase * externalPrice,
          allQuote + allBase * externalPrice
        );
      }
