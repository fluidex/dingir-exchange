-- Your SQL goes here
CREATE SEQUENCE balance_history_seq;

CREATE TABLE balance_history (
    id            BIGINT CHECK (id >= 0) NOT NULL PRIMARY KEY DEFAULT NEXTVAL ('balance_history_seq'),
...
CREATE TABLE trade_history (
    id            BIGINT CHECK (id >= 0) NOT NULL PRIMARY KEY DEFAULT NEXTVAL ('trade_history_seq'),
    time          TIMESTAMP(0) NOT NULL,
    user_id       INT CHECK (user_id >= 0) NOT NULL,
    market        VARCHAR(30) NOT NULL,
